...
a persistence unit "employee-msPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "employee-ms/pom.xml":
...
artifact ("employee-ms.war") is already built. You can build
